      ...
      <div>
        <div className="relative rounded-xl overflow-hidden mb-3">
          <img
            ...
            className="w-full h-80 sm:h-72 md:h-72 object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#212529]/80 to-[#212529]/30 flex flex-col justify-center px-6 py-8 md:p-10">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-3 md:max-w-md leading-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-5">
              <Button 
                ...
                className="px-6 py-2 rounded-full sm:w-max text-sm bg-[#f74ea7] hover:bg-[#f74ea7]/90 text-white font-medium"
              >
                Ver cardápios
              </Button>
              <Button 
                onClick={() => setLocation('/products')}
                className="px-6 py-2 rounded-full sm:w-max text-sm bg-white hover:bg-gray-100 text-[#f74ea7] font-medium"
                variant="outline"
              >
                Explorar produtos
              </Button>
